        ...
        <section class="slide2">
            ...
            <div class="left">
                ...
                <a href=""> <button type="submit"
                        class="btn1 w-[100px] h-[40px] text-[#fff] text-[15px] bg-[#2DABCA]  inline-block font-[cursive]  cursor-pointer transition-all duration-[.4s] rounded-[40px]">View
                        all</button></a>

            </div>
            <p
                class=" com text-[18px]  text-[#13709a] font-bold mb-[20px] drop-shadow-md  relative left-[8px] top-[14px] ">
                View Recent Companies </p>
